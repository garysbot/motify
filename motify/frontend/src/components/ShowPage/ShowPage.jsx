...
//           <p key={album.id} className='details-artist'>
//             {album.artistName}
...
//         </div>
//         <hr></hr>
//         <div key={album.id} className='show-songs-table'>
//           {
...
//                         ) : (
//                         <p key={album.id}>{trackNum}</p>
//                       )}
//                     </div>
//                     <div className='song-title-artist-container'>
//                       <p key={album.id} className='song-title'>
//                         {song.title}
//                       </p>
//                       {/* Explicit */}
//                       <p key={album.id} className='song-title-artist-name'>
//                         {album.artistName}  
//                       </p>
//                     </div>
//                   </div>
...
//                       <p key={album.id} className='duration-text'>
//                         {
